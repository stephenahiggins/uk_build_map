...
const LOCAL_AUTHORITIES: { code: string; name: string }[] = [
  ...
  { code: 'E06000060', name: 'Buckinghamshire' },
  { code: 'E06000061', name: 'North Northamptonshire' },
  { code: 'E06000062', name: 'West Northamptonshire' },
  { code: 'E06000063', name: 'Cumberland' },
  { code: 'E06000064', name: 'Westmorland and Furness' },
  { code: 'E06000065', name: 'North Yorkshire' },
  { code: 'E06000066', name: 'Somerset' },
...
async function main() {
  ...
  // ‼️ Projects are now seeded from prisma/seed/LFG.sql ‼️
  // ‼️ Run: docker-compose exec db mysql -u root -prootpassword node_boilerplate < prisma/seed/LFG.sql ‼️
  
  /* COMMENTED OUT - Projects now seeded from LFG.sql
